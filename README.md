...
High charges for setup are usually above a lakh.
Low Margin
Competition among sellers.
Difficult to manage for a small shop owner.
While what we are giving them is their own website for free, with multiple features such as -

Sales Records & Order Management.

Very Low commission based on the category of products.

Various templates to choose from.

Features of a modern E-commerce website such as

Promo Codes & Discount Offers
COD/ Online Payment
Marking Products as Unavailable/ Out Of Stock.
SMS alerts for order's received.
Dedicated Executive for helping them out in adding products & managing inventory.
