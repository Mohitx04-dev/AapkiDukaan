...
//         {props.Arr.map(el=>{
//             return (
//                 <Link className="hover:bg-searchBarGrey text-theme   text-left rounded-md p-1 underline" to={"#"} key={el}>{el}</Link>
//             )
//         })}
//          </div>
//     )   
...
function Footer(props) {
    ...
    return (
        ...
        <p className="text-sm">Copyright © 2022 aapkidukaan.live | powered by Aapki Dukaan</p>
        </div>
    )
}
